...
```
[![SQL](/assets/img/writeups/hackthebox/escapeTwo/sql_rose.png)](/assets/img/writeups/hackthebox/escapeTwo/sql_rose.png)
...
```
[![SMB](/assets/img/writeups/hackthebox/escapeTwo/smb_rose.png)](/assets/img/writeups/hackthebox/escapeTwo/smb_rose.png)

Vemos dos archivos xlsx que pueden ser interesante, si accedemos al contenido vamos a encontrar buena información.

[![Excel](/assets/img/writeups/hackthebox/escapeTwo/xlsx_usuarios.png)](/assets/img/writeups/hackthebox/escapeTwo/xlsx_usuarios.png)
...
[![CRACKMAP](/assets/img/writeups/hackthebox/escapeTwo/crack_sa.png)](/assets/img/writeups/hackthebox/escapeTwo/crack_sa.png)
...
[![SQL](/assets/img/writeups/hackthebox/escapeTwo/sql_sa.png)](/assets/img/writeups/hackthebox/escapeTwo/sql_sa.png)

[![SHELL](/assets/img/writeups/hackthebox/escapeTwo/shell_sa.png)](/assets/img/writeups/hackthebox/escapeTwo/shell_sa.png)
...
[![SHELL](/assets/img/writeups/hackthebox/escapeTwo/sa_users.png)](/assets/img/writeups/hackthebox/escapeTwo/sa_users.png)
...
[![SHELL](/assets/img/writeups/hackthebox/escapeTwo/sql-conf_info.png)](/assets/img/writeups/hackthebox/escapeTwo/sql-conf_info.png)
...
[![TERM](/assets/img/writeups/hackthebox/escapeTwo/passwords.png)](/assets/img/writeups/hackthebox/escapeTwo/passwords.png)

```bash
crackmapexec winrm 10.10.11.51 -u users.txt -p passwords.txt
```
[![CRACKMAP](/assets/img/writeups/hackthebox/escapeTwo/ryan_pwned.png)](/assets/img/writeups/hackthebox/escapeTwo/ryan_pwned.png)
...
[![Flag](/assets/img/writeups/hackthebox/escapeTwo/user_flag.png)](/assets/img/writeups/hackthebox/escapeTwo/user_flag.png)

## Análisis del usuario 

[![WINRM](/assets/img/writeups/hackthebox/escapeTwo/ryan_permisos.png)](/assets/img/writeups/hackthebox/escapeTwo/ryan_permisos.png)
...
[![AD](/assets/img/writeups/hackthebox/escapeTwo/certuser.png)](/assets/img/writeups/hackthebox/escapeTwo/certuser.png)
...
[![ACL](/assets/img/writeups/hackthebox/escapeTwo/acls.png)](/assets/img/writeups/hackthebox/escapeTwo/acls.png)
...
```
[![ACL](/assets/img/writeups/hackthebox/escapeTwo/dumcert.png)](/assets/img/writeups/hackthebox/escapeTwo/dumcert.png)
...
```
[![ESC1](/assets/img/writeups/hackthebox/escapeTwo/certificado_guardado.png)](/assets/img/writeups/hackthebox/escapeTwo/certificado_guardado.png)
...
```
[![ESC1](/assets/img/writeups/hackthebox/escapeTwo/certificado_admin.png)](/assets/img/writeups/hackthebox/escapeTwo/certificado_admin.png)
...
[![Flag](/assets/img/writeups/hackthebox/escapeTwo/root_flag.png)](/assets/img/writeups/hackthebox/escapeTwo/root_flag.png)
